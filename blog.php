...
<body>    
    ...
    <section id="menu">
        <section id="lang-switch">
            <button onclick="changeLang('fr')"><a href="blog.php?lang=fr">Français</a></button>
            <button onclick="changeLang('ru')"><a href="blog.php?lang=ru">Русский</a></button>
        </section>
        <nav>
            <ul>
                <li><a href="index.php<?php echo $lang ?>"><?= $trad['home'] ?></a></li>
                <li><a href="cours.php<?php echo $lang ?>"><?= $trad['products'] ?></a></li>
                <li><a class="active" href="blog.php<?php echo $lang ?>"><?= $trad['blog'] ?></a></li>
    ...
    foreach ($articles as $article) : ?>
        <article>
            ...
            <?php if(isset($_SESSION['adminId'])) {?>
                <button name= "delete" data-article-id="<?= $article['id'] ?>"><?= $trad['delete'] ?></button>
